     ...
     */
		...
		public function start_lvl( &$output, $depth = 0, $args = array() ) {
			$indent = str_repeat( "\t", $depth );
				$output .= $indent."<div aria-hidden='true' role='tooltip' class=\"navbar-dropdown is-boxed";
    ...
    /**
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( ! $args['has_children'] ) {//if doesn't have children
				...
				$item_output .= $indent . '<div class="navbar-item has-dropdown" aria-haspopup="true" aria-expanded="false" data-target="dropdown"><!-- START DROPDOWN-->' . "\n";
