...
/* ------------------------------------------------------------------------- */
    ...
    **********************/
            ...
            <div  data-type="link" data-id="post-<?php the_ID(); ?>" <?php post_class('column is-4-desktop is-6-mobile feed'); ?> >
              ...
              <div data-type="video" data-id="post-<?php the_ID(); ?>" <?php post_class('column is-4-desktop is-6-mobile feed '); ?> >
                ...
                <article>
  				...
  				<?php
          // setup terms which contain all filters
          ...
          $alt = get_post_meta($thumbnail_id, '_wp_attachment_image_alt', true);
            ...
            <div class="typeIcon">
              ...
              <?php } ?>
  						...
  						<?php }
              // else if you have no header image show icon background
               else { ?>
    ...
    // if tags exist open them up and create the checkboxes
		if($sliced_tags){
    ...
    // if no tags exist
        ...
        // video opens as a modal instead of on Youtube
...
function getTags( $args, $tagSearchString ) {
    ...
    // the search loop holds post data
...
?>
<?php include_once(get_template_directory() . '/includes/content/resource-library/includes/partials/magnefic-iframe.php')?>
