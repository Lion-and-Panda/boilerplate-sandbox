<ul aria-label="Social Media Links">
	...
	<!--Youtube-->
	<?php if ( $youtube ) { ?>
	<li><a target="_blank" rel="noopener" aria-label="Visit our YouTube account" href="<?php echo $youtube; ?>" style= "color:<?= $icon_color ;?>;"><i class="fab fa-youtube" role="img" aria-label="Visit our YouTube account" style="font-size:<?= $icon_size ;?>rem;"></i></a></li>
	...
	<!--Flickr-->
	<?php if ( $flickr ) { ?>
	<li><a target="_blank" rel="noopener" href="<?php echo $flickr; ?>" style= "color:<?= $icon_color ;?>;"><i class="fab fa-flickr" role="img" aria-label="Visit our Flickr account" style="font-size:<?= $icon_size ;?>rem;"></i></a></li>
